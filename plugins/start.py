...
async def start(client,message):
	...
	reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton('⚚     ɱᴀɪɴ   ᴄʜᴀɴɴᴇʟ     ⚚', url='https://telegram.me/ak_backup_72')],[InlineKeyboardButton('👨‍💻   ᴏᴡɴᴇʀ', url='https://telegram.me/Ak74400'),InlineKeyboardButton('📝   ᴀʙᴏᴜᴛ', callback_data = "upgrade")]]))
	    return
	if id:
	    if old == True:
	        try:
